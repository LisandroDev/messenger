...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7194)), "/home/lisandro/Desktop/Projects/messenger/messenger-frontend/app/(root)/page.tsx"],
...
'loading': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4200)), "/home/lisandro/Desktop/Projects/messenger/messenger-frontend/app/loading.ts"],
    ...
    const pages = ["/home/lisandro/Desktop/Projects/messenger/messenger-frontend/app/(root)/page.tsx"];
...
/* harmony import */ var react_hook_form__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1031);
/* harmony import */ var next_navigation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9483);
/* harmony import */ var next_navigation__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(next_navigation__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _app_home_utils_fetcher__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(5850);
/* harmony import */ var react_toastify__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3578);
...
function AuthForm() {
    const [variant, setVariant] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)("LOGIN");
    ...
    // Form Handler
    const { register, handleSubmit, watch, formState: { errors } } = (0,react_hook_form__WEBPACK_IMPORTED_MODULE_4__/* .useForm */ .cI)({
        defaultValues: {
            name: "",
            password: "",
            email: ""
    ...
    const onSubmit = async (data)=>{
        ...
        if (variant === "REGISTER") {
            ...
            try {
                ...
                if (res.status === 200) {
                    setVariant("LOGIN");
                    react_toastify__WEBPACK_IMPORTED_MODULE_3__/* .toast */ .Am.success("Account created successfully");
                } else {
                    react_toastify__WEBPACK_IMPORTED_MODULE_3__/* .toast */ .Am.error("An error occurred");
                }
            } catch (error) {
                react_toastify__WEBPACK_IMPORTED_MODULE_3__/* .toast */ .Am.error("An error occurred");
            }
        ...
        if (variant === "LOGIN") {
            ...
            try {
                const res = await (0,_app_home_utils_fetcher__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(`${"https://messengerapp-27vj.onrender.com"}/api/auth/login`, {
                    method: "POST",
                    credentials: "include",
                    headers: {
                        "Content-Type": "application/json"
                ...
                if (res.status === 200) {
                    ...
                    react_toastify__WEBPACK_IMPORTED_MODULE_3__/* .toast */ .Am.success("Login successful");
                    router.push("/home");
                    router.push("/home");
                } else {
                    react_toastify__WEBPACK_IMPORTED_MODULE_3__/* .toast */ .Am.error("An error occurred");
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("form", {
        ...
        children: [
            variant === "REGISTER" && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                children: [
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                ...
                children: variant === "LOGIN" ? "New to Messenger? Create an account" : "Already have an account? Sign in"
            })
        ]
    });
}
...
;// CONCATENATED MODULE: ./app/(root)/components/AuthForm.tsx

const proxy = (0,module_proxy.createProxy)(String.raw`/home/lisandro/Desktop/Projects/messenger/messenger-frontend/app/(root)/components/AuthForm.tsx`)
...
/* harmony default export */ const AuthForm = (__default__);
;// CONCATENATED MODULE: ./app/(root)/page.tsx
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: "mx-3 sm:mx-auto sm:w-full sm:max-w-md",
                children: [
